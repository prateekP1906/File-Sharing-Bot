...
from bot import Bot
from config import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, FILE_AUTO_DELETE, FORCE_SUB_CHANNEL, FORCE_SUB_CHANNEL_2
from helper_func import subscribed, encode, decode, get_messages
from database.database import add_user, del_user, full_userbase, present_user, update_request_status
...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            ...
            InlineKeyboardButton(text="Join Channel 2", url="https://t.me/+BKhbDSbyshY4ZmI9") # <-- Make sure line 118 has that comma!
        ]
    ]
    
    # This part handles the "Try Again" button if there's a file link
...
async def handle_join_request(client, request: ChatJoinRequest):
    try:
        # Match the chat ID to record the correct channel request
