...
async def is_subscribed(filter, client, update):
    ...
    # 3. Check MongoDB "Memory" for Pending Requests
    req1, req2 = await check_request_status(user_id)
    
    # FINAL LOGIC: User passes only if (Member1 OR Req1) AND (Member2 OR Req2)
